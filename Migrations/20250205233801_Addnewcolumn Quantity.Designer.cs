...
{
    [DbContext(typeof(MASHROEEDbContext))]
    [Migration("20250205233801_Addnewcolumn Quantity")]
    partial class AddnewcolumnQuantity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MASHROEE.Models.Product", b =>
                {
                    ...
                    b.HasOne("MASHROEE.Models.Applicationuser", "user")
                        .WithMany()
